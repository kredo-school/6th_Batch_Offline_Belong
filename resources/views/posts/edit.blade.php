        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('posts.update', $post->id) }}" enctype="multipart/form-data"> <!-- 修正 -->
                            @csrf
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-8">
                                    <select id="category" class="form-select" name="category" required>
                                        ...
                                        <option value="play" {{ $post->category === 'play' ? 'selected' : '' }}>Play</option>
                                        <option value="watchandlearn" {{ $post->category === 'watchandlearn' ? 'selected' : '' }}>Watch and Learn</option>
                                        <option value="eat" {{ $post->category === 'eat' ? 'selected' : '' }}>Eat</option>
