...
<div class="container-fluid p-0">
    ...
    <div class="row g-4"> <!-- g-4 でカラム間の間隔を調整 -->
        <div class="col-md-3 col-sm-6"> <!-- 各カードを4分割 -->
            <div class="card h-100"> <!-- h-100 で高さを揃える -->
                <img src="{{ asset('images/play.jpg') }}" alt="Image 1" class="card-img-top" style="object-fit: cover;">
                <div class="card-body">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="card h-100">
                <img src="{{ asset('images/Watch and Learn.jpg') }}" alt="Image 2" class="card-img-top" style="object-fit: cover;">
                <div class="card-body">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="card h-100">
                <img src="{{ asset('images/eat.jpg') }}" alt="Image 3" class="card-img-top" style="object-fit: cover;">
                <div class="card-body">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="card h-100">
                <img src="{{ asset('images/others.jpg') }}" alt="Image 4" class="card-img-top" style="object-fit: cover;">
                <div class="card-body">
    ...
    <div class="row justify-content-center mt-4">
        <div class="col-md-8">
            ...
            <div class="row align-items-center mb-4 p-2 rounded border shadow-sm" style="font-size: 14px;"> <!-- カードを小さく -->
                <div class="col-auto">
                    <a href="{{ route('posts.show', $post->id) }}">
                        <!-- 投稿画像 -->
                        @if($post->image)
                            <img src="{{ $post->image }}" alt="{{ $post->title }}" class="img-fluid" style="width: 50px; height: 50px; object-fit: cover;">
                        @else
                ...
                <div class="col ms-3">
                    <a href="{{ route('posts.show', $post->id) }}" class="text-decoration-none text-dark">
                        ...
                        <p class="text-muted mb-0">{{ Str::limit($post->content, 80) }}</p> <!-- コンテンツの表示を短く -->
                    </a>
                </div>
            </div>
            @endforeach
    ...
    @elseif(isset($posts) && $posts->count() == 0) <!-- 件数が0の場合のメッセージ表示 -->
    <div class="row justify-content-center mt-4">
